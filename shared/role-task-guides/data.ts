...
export const ROLE_TASK_GUIDES: RoleTaskGuide[] = [
...
export function getRoleTaskGuide(appKey: string, variantKey?: string | null): RoleTaskGuide | null {
  if (variantKey) {
...
export function listRoleTaskGuides(appKey?: string): RoleTaskGuide[] {
