...
export const APPROACH_DEFINITIONS: ApproachDefinition[] = [
  ...
  },
  {
    ...
    processSteps: ['Establish baseline', 'Select simillimum', 'Plan Fibonacci ladder', 'Monitor checkpoints', 'Adjust'],
    ...
    repertory: { enabled: true, defaultRubricWeight: 2 },
    prescription: { potencyGuidance: 'Document Fibonacci sequence and interval before prescribing.' }
  },
  {
    slug: 'tautopathy-isopathy',
    methodNormalizedLabel: 'tautopathy isopathy',
    title: 'Tautopathy / Isopathy',
    shortDescription: 'Prescribing based on causal substance or isopathic relationship to disease agent.',
    focus: 'Causal clearing and tautopathic remedy selection.',
    bestFor: ['Drug/vaccine reactions', 'Toxic exposure', 'Iatrogenic layers'],
    processSteps: ['Identify causal agent', 'Map exposure timeline', 'Select tautopathic potency', 'Track clearing'],
  ...
  },
  {
    ...
    shortDescription: 'Layered prescribing across lesion, functional, constitutional, and fundamental levels.',
    focus: 'Sequential layer-wise remedy planning.',
    bestFor: ['Deep chronic disease', 'Multi-layer pathology', 'Structured long-term care'],
    processSteps: ['Map lesion layer', 'Assess functional layer', 'Integrate constitution', 'Plan fundamental layer'],
  ...
  },
  {
    ...
    shortDescription: 'Essence themes, level of health, and defense mechanisms in remedy selection.',
    ...
    processSteps: ['Identify essence theme', 'Assess level of health', 'Map defense', 'Select essence-matched remedy'],
  ...
  },
  {
    ...
    processSteps: ['Identify target organs', 'Select drainage remedies', 'Sequence with simillimum', 'Monitor'],
    ...
    repertory: { enabled: true, defaultRubricWeight: 2 },
    prescription: { adviceTemplate: 'Document drainage/support remedies separately from simillimum.' }
  },
  {
    slug: 'hering-law-tracker',
    methodNormalizedLabel: 'hering law tracker',
    title: "Hering's Law Tracker",
    shortDescription: 'Follow-up approach centered on direction of cure and aggravation monitoring.',
    focus: "Hering's law and post-prescription aggravation tracking.",
    bestFor: ['Follow-up visits', 'Potency decisions', 'Teaching clinics'],
    processSteps: ['Record baseline', 'Prescribe', 'Track aggravation', 'Assess direction of cure', 'Adjust'],
  ...
  },
  {
    ...
    processSteps: ['Capture acute complaint', 'Select key rubrics', 'Choose remedy', 'Plan potency'],
    ...
    prescription: { potencyGuidance: 'Favor moderate potency with clear repetition rules in acute cases.' }
  },
  {
    slug: 'combination-remedy-mode',
    methodNormalizedLabel: 'combination remedy mode',
    title: 'Combination / Complex Remedy Mode',
    shortDescription: 'Structured use of complex or combination remedies with documented indication match.',
    ...
    repertory: { enabled: false },
    prescription: { skipRepertory: true, adviceTemplate: 'Document combination rationale and duration.' }
  }
];
