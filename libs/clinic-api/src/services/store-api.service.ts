...
import { ACTIVITY_PERIODS, DEFAULT_PAGE, EXPIRING_ALERTS_DEFAULT_DAYS, PAGE_SIZES } from '../constants/store-pagination.constants';

@Service()
export class StoreApiService {
  private http = inject(HttpClient);
  private baseUrl = inject(CLINIC_API_BASE_URL);
