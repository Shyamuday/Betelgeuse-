...
export const skinCareDiseaseInfo: DiseaseInfo = {
  ...
  causes: [
    ...
    'Weather or diet triggers',
  ],
  riskFactors: [
    'Sensitive skin',
    'Harsh cosmetics',
    'Repeated steroid cream use',
    'Sweating and friction',
    'Family tendency',
  ],
  diagnosis:
    'Diagnosis is based on visual pattern, symptom history, triggers, previous product use, and provider assessment. Clear photos are often helpful.',
  tests: [
    'Usually not required for mild cases',
    'Allergy or infection evaluation may be advised if symptoms suggest',
  ],
  treatmentOptions: {
    allopathy:
      'May be needed for infection, severe inflammation, or acne depending on provider review.',
    ...
    lifestyle:
      'Skin routine simplification, trigger avoidance, and hygiene correction are important.',
  },
  medications: [
    'Avoid unsupervised steroid creams',
    'Prescription depends on severity and diagnosis',
  ],
  homeCare: [
    'Use gentle cleanser',
    'Avoid new products during flare',
    'Do not scratch or pick lesions',
  ],
  prevention: ['Patch test products', 'Avoid known triggers', 'Maintain simple skincare routine'],
  severityLevel:
    'Mild and recurring concerns are suitable online; severe swelling or infection needs urgent offline care.',
  whenToSeeDoctor:
    'Consult if symptoms recur, spread, itch severely, leave marks, or do not improve with routine correction.',
  emergencySigns: [
    'Breathing difficulty',
    'Rapid facial swelling',
    'High fever',
    'Spreading painful redness',
  ],
  duration:
    'Depends on cause; follow-up may be needed for recurring acne, pigmentation, or allergy tendency.',
  stages: [
    'Photo/history review',
    'Trigger identification',
    'Prescription/routine plan',
    'Follow-up',
  ],
  commonIn: {
  ...
  references: ['Clinical review by consultation provider'],
  careApproach: [
