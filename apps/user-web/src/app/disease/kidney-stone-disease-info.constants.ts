...
export const kidneyStoneDiseaseInfo: DiseaseInfo = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'Stones under 4 mm pass spontaneously in about 80% of cases. Stones 4–6 mm pass in about 60% of cases, often with the help of alpha-blockers. Stones above 6 mm are less likely to pass without intervention. Your provider will assess stone size and location from your imaging report to guide the decision.',
    },
    {
  ...
  references: [
    ...
    'Clinical review by HopeHub Care and Research Centre consultation providers',
  ],
