...
export const hairFallDiseaseInfo: DiseaseInfo = {
  ...
  diagnosis:
    'Diagnosis is based on symptom duration, hair fall pattern, scalp condition, lifestyle history, and provider review. Photos may be requested during consultation.',
  tests: [
  ...
  medications: [
    'Prescription depends on provider assessment',
    'Avoid self-medication or steroid-based scalp products',
  ],
  homeCare: [
    'Use gentle shampoo',
    'Avoid harsh chemical treatments',
    'Do not over-oil an infected or itchy scalp',
  ],
  prevention: [
    'Treat dandruff early',
    'Maintain nutrition',
    'Avoid crash dieting',
    'Track hair fall triggers',
  ],
  severityLevel:
    'Mild to moderate cases are suitable for online consultation; rapidly patchy or infected scalp needs closer review.',
  whenToSeeDoctor:
    'Consult if hair fall persists beyond 3-4 weeks, is patchy, or is associated with itching, dandruff, pain, or scalp lesions.',
  emergencySigns: [
    'Sudden painful scalp swelling',
    'Pus or spreading infection',
    'High fever with scalp symptoms',
  ],
  duration:
    'Improvement is usually tracked over weeks to months depending on cause and consistency.',
  stages: [
    'Initial intake',
    'Provider assessment',
  ...
  faq: [
    {
      ...
      answer:
        'It depends on the cause. Some shedding improves quickly, while chronic or pattern hair fall needs longer follow-up.',
    },
    {
      question: 'Do I need to upload photos?',
      answer:
        'The provider may request scalp or hairline photos during chat for better assessment.',
    },
  ],
  reviewedBy: 'HopeHub Care and Research Centre care team',
  lastUpdated: '2026-04-27',
  references: [
    'Clinical review by consultation provider',
    'Patient-provided history and symptom tracking',
  ],
  careApproach: [
  ...
  details: [
    ...
    'Your provider may ask for scalp photos, lifestyle history, recent illness history, and family history.',
