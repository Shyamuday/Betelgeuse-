...
export const HOME_CONTENT = {
  ...
  booking: {
    ...
    hint: 'Secure OTP login. No password needed.',
  ...
  treatmentCards: [
    {
      ...
      body:
        'From fever, cough, and infections to diabetes, arthritis, skin disorders, and mental health — our doctors treat the full range of acute and chronic illnesses with individualized homeopathic prescribing.',
    ...
    },
    {
      ...
      body:
        "Explore conditions by category — respiratory, digestive, skin, hair, women's health, children's health, and more — then start a consultation for your specific issue.",
      features: ['Organ-wise categories', 'Common & rare conditions', 'Doctor-matched to your case'],
  ...
  whyChoose: {
    ...
    benefits: [
      { icon: '🔒', title: 'Private & secure', body: 'End-to-end encrypted consultations with strict data privacy.' },
      { icon: '📊', title: 'Pattern tracking', body: 'We track symptom patterns over time, not just single episodes.' },
      { icon: '🩺', title: 'Doctor continuity', body: 'Same doctor follows your case through the entire care journey.' },
      { icon: '📱', title: 'Easy follow-ups', body: 'Secure chat and scheduled check-ins without rebooking fees.' }
  ...
  safetyFaq: {
    safety: {
      title: 'Safety first',
      body:
        'This platform is not for emergencies. Severe pain, breathing trouble, heavy bleeding, or sudden worsening symptoms require immediate offline medical care.',
...
export const ABOUT_CONTENT = {
  page: {
    ...
    body:
      'Vitalis Care and Research Centre brings structured online homeopathic care under one trusted clinic brand. Patients choose their health concern, share symptoms, and our internal doctor panel guides the full treatment journey — from first consultation to prescription and follow-up.'
  },
  pillars: [
    {
      eyebrow: 'What we do',
      ...
      body:
        "We help patients with acute illnesses, chronic diseases, skin and hair concerns, allergies, digestive issues, women's and children's health, mental wellness, and more. Our focus is individualized homeopathic treatment with continuity — not one-time advice."
    },
    {
      eyebrow: 'Our approach',
      title: 'Homeopathy-led, less-medicine care',
      body:
        "We prefer gentle, individualized care with a homeopathy-first mindset where appropriate. Our goal is to reduce unnecessary medication load and support the body's long-term healing process."
    },
    {
      eyebrow: 'Our expertise',
      title: 'Whole-person homeopathic care',
      body:
        'Every case is reviewed as a whole — symptoms, constitution, triggers, and history — so treatment fits the person, not just the disease label. This applies whether your concern is new, recurring, or long-standing.'
    }
  ] satisfies readonly PublicContentPanel[],
  mission: {
    title: 'Mission',
    body:
      'To make trusted, affordable, doctor-led care accessible for patients who need thoughtful treatment, follow-up, and long-term support.'
  },
  vision: {
    title: 'Vision',
    body:
      'To build a digital homeopathic clinic known for results, trust, ethical care, and gentle individualized treatment across all health conditions.'
  },
...
export const TREATMENTS_PAGE_CONTENT = {
  ...
  body:
    'Vitalis Care and Research Centre offers doctor-led online consultations across all disease categories. Choose your concern, share your symptoms, and receive individualized homeopathic care with follow-up support.',
  ...
  issueSelectionBody: 'Continue to consultation and share symptoms for this issue with our doctor panel.',
...
export const CHRONIC_CARE_PAGE_CONTENT = {
  ...
  body:
    'Homeopathy treats the person as a whole. Whether your concern is recent or long-standing, our doctors take detailed history, match the right remedy, and support you through follow-up until you recover.',
  ctaLabel: 'Browse all conditions',
  ctaHref: '/treatments',
  pillars: [
    { title: 'Any condition', body: 'From fever and infections to diabetes, arthritis, skin, hair, and mental health.' },
    { title: 'Individualized care', body: 'Remedy selection based on your full symptom picture and constitution.' },
    { title: 'Ongoing support', body: 'Prescriptions, medicine delivery, and follow-up consultations when you need them.' }
  ] satisfies readonly PublicContentPanel[]
} as const;
...
export const BLOG_PAGE_CONTENT = {
  ...
  body:
    'Our clinical team shares practical, plain-language insights to help patients understand their conditions, make informed decisions, and support their care between consultations.'
} as const;
...
export const ROUTE_SEO_CONTENT = {
  ...
  'treatments/:slug': {
    ...
    seoDescription: 'Read treatment details, common symptoms, care approach, and safety guidance at Vitalis Care.'
  },
  'our-doctors': {
