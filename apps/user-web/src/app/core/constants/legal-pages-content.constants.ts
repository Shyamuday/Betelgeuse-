...
export const LEGAL_HUB_CONTENT = {
  ...
  intro:
    'Read how HopeHub Care and Research Centre handles your data, consultations, payments, medicine orders, delivery, cancellations, refunds, and returns.',
  links: [
...
export const LEGAL_PAGES = {
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          'To provide online consultations, doctor assignment, prescriptions, reminders, and follow-up care.',
      ...
      },
      {
        ...
        paragraphs: [
          'Consultation and prescription information is shared only with authorised doctors, pharmacists, care coordinators, and operations staff who need it to deliver your care.',
    ...
    sections: [
      {
        ...
        paragraphs: [
          'We provide doctor-led online homeopathic consultations, digital prescriptions where clinically appropriate, follow-up messaging, and medicine fulfilment support.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'You agree to use medicines only as directed by the prescribing doctor.',
        ],
      },
      {
        title: 'User conduct',
        bullets: [
          'Do not misuse the platform, submit false information, harass staff or doctors, or attempt unauthorised access.',
  ...
  returnExchange: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Consultation fee refunds are governed by our Payment Policy and depend on whether the doctor has started clinical review, whether the consultation was completed, or whether the case was cancelled due to clinic unavailability.',
        ],
      },
      {
        title: 'Contact',
  ...
  cancellationRefund: {
    ...
    headerSubtitle: 'Cancellation & Refund',
    eyebrow: 'Cancellation & Refund Policy',
    title: 'Cancellation, reschedule, and refund rules.',
    intro:
      'This policy explains when consultation requests, medicine orders, and failed or duplicate payments may be cancelled, rescheduled, or refunded.',
    lastUpdated: 'July 2026',
    sections: [
      {
        title: 'Consultation cancellation',
        bullets: [
          'You may request cancellation or rescheduling before doctor review or consultation assignment begins.',
          'Once a doctor has started review, chat, call, prescription work, or follow-up planning, the consultation fee may become non-refundable.',
          'If HopeHub Care cannot provide the consultation because of clinic-side unavailability, we will offer a reschedule or full refund.',
          'No refund is available after a completed consultation except where required by law or where a confirmed billing error occurred.',
        ],
      },
      {
        title: 'Medicine order cancellation',
        bullets: [
          'Medicine orders may be cancelled before packing or dispatch starts.',
          'After dispatch, cancellation is handled under the Return & Exchange Policy because medicines are regulated healthcare products.',
          'If an item becomes unavailable after payment, we will refund the unavailable portion or offer a suitable alternative only with your consent.',
        ],
      },
      {
        title: 'Failed, duplicate, or excess payments',
        bullets: [
      ...
      },
      {
        ...
        bullets: [
          'Email support with your registered mobile or email, consultation or order ID, payment reference, and reason for the request.',
          'Our team may ask for additional details before approving a refund.',
          'Approved refunds are processed to the original payment method wherever possible.',
        ],
      },
      {
        title: 'Contact',
        paragraphs: [`Cancellation or refund questions: ${CONTACT_EMAIL}`],
      },
    ],
  },
  shipping: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          'Payment confirms your request in the clinic queue for doctor assignment and review.',
          'If a consultation cannot be provided due to clinic-side cancellation, a full refund or reschedule option will be offered.',
          'If you cancel before doctor review begins, refund eligibility is assessed as per clinic rules shown at checkout.',
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          'Cancellation-specific rules are described in our Cancellation & Refund Policy.',
...
export const LEGAL_PAGE_ROUTES: readonly { path: string; key: LegalPageKey }[] = [
  ...
  { path: 'cancellation-and-refund-policy', key: 'cancellationRefund' },
