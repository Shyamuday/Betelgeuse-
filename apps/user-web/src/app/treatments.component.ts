...
export class TreatmentsComponent implements OnInit {
  ...
  copy: RuntimePublicCopy<typeof TREATMENTS_PAGE_CONTENT> = TREATMENTS_PAGE_CONTENT;
  ...
  private async loadPageCopy() {
    const page = await this.publicPages.bySlug('treatments');
    if (!page) return;
    this.copy = {
      ...TREATMENTS_PAGE_CONTENT,
      headerSubtitle: page.subtitle || TREATMENTS_PAGE_CONTENT.headerSubtitle,
      eyebrow: page.subtitle || TREATMENTS_PAGE_CONTENT.eyebrow,
      title: page.title,
      body: page.summary || TREATMENTS_PAGE_CONTENT.body,
    };
  }
