      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () =>
              import('./pages/store-manager/dashboard/dashboard.component').then((m) => m.DashboardComponent)
          },
          {
            path: STORE_MANAGER_PATHS.PATIENTS,
            loadComponent: () =>
              import('./pages/store-manager/patients/patients-page').then((m) => m.PatientsPage)
          },
          {
            path: STORE_MANAGER_PATHS.SEARCH,
            loadComponent: () =>
              import('./pages/store-manager/search/search.component').then((m) => m.SearchComponent)
          },
          {
            path: STORE_MANAGER_PATHS.MEDICINE_DETAIL,
            loadComponent: () =>
              import('./pages/store-manager/medicine-detail/medicine-detail.component').then(
                (m) => m.MedicineDetailComponent
              )
          },
          {
            ...
            loadComponent: () =>
              import('./pages/store-manager/alerts/alerts.component').then((m) => m.AlertsComponent)
          },
          {
            path: STORE_MANAGER_PATHS.RACK_MAP,
            loadComponent: () =>
              import('./pages/store-manager/rack-map/rack-map.component').then((m) => m.RackMapComponent)
          },
          {
            path: STORE_MANAGER_PATHS.MEDICINES,
            loadComponent: () =>
              import('./pages/store-manager/medicines-admin/medicines-admin.component').then(
                (m) => m.MedicinesAdminComponent
              )
          },
          {
            ...
            loadComponent: () =>
              import('./pages/store-manager/movements/movements.component').then((m) => m.MovementsComponent)
          },
          {
            path: STORE_MANAGER_PATHS.STAFF_ACTIVITY,
            loadComponent: () =>
              import('./pages/store-manager/staff-activity/staff-activity.component').then(
                (m) => m.StaffActivityComponent
              )
          },
          {
            ...
            loadComponent: () =>
              import('./pages/store-manager/staff-hr/staff-hr.component').then((m) => m.StaffHrComponent)
          },
          {
            path: STORE_MANAGER_PATHS.STORE_EXPENSES,
            loadComponent: () =>
              import('./pages/store-manager/store-expenses/store-expenses-page').then((m) => m.StoreExpensesPage)
          },
          {
