...
@Component({
  ...
  styles: [`
    .login-page {
      ...
      padding: 24px;
      background-image: radial-gradient(ellipse at 30% 20%, rgba(6, 182, 212, 0.06) 0%, transparent 60%),
                        radial-gradient(ellipse at 70% 80%, rgba(6, 182, 212, 0.04) 0%, transparent 60%);
    }
