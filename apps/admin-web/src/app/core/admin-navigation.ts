...
const ROUTE_PERMISSIONS: Record<string, string[]> = {
  ...
  [ROUTE_PATHS.HOME_CAROUSEL]: [ADMIN_PERMISSIONS.CATALOG_READ, ADMIN_PERMISSIONS.CATALOG_WRITE],
  [ROUTE_PATHS.PUBLIC_PAGES]: [ADMIN_PERMISSIONS.CATALOG_READ, ADMIN_PERMISSIONS.CATALOG_WRITE],
