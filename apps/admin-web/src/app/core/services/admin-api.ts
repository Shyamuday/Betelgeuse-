...
export class AdminApi {
  ...
  listPublicPages() {
    return this.doctors.listPublicPages();
  }
  seedPublicPages() {
    return this.doctors.seedPublicPages();
  }
  createPublicPage(...args: Parameters<AdminDoctorsApi['createPublicPage']>) {
    return this.doctors.createPublicPage(...args);
  }
  updatePublicPage(...args: Parameters<AdminDoctorsApi['updatePublicPage']>) {
    return this.doctors.updatePublicPage(...args);
  }
  ...
  listHomeAnnouncements() {
    return this.doctors.listHomeAnnouncements();
  }
  createHomeAnnouncement(...args: Parameters<AdminDoctorsApi['createHomeAnnouncement']>) {
    return this.doctors.createHomeAnnouncement(...args);
  }
  updateHomeAnnouncement(...args: Parameters<AdminDoctorsApi['updateHomeAnnouncement']>) {
    return this.doctors.updateHomeAnnouncement(...args);
  }
  deleteHomeAnnouncement(...args: Parameters<AdminDoctorsApi['deleteHomeAnnouncement']>) {
    return this.doctors.deleteHomeAnnouncement(...args);
  }
  listTestimonials() {
  ...
  importStaticDiseasePages(...args: Parameters<AdminCatalogApi['importStaticDiseasePages']>) {
    return this.catalog.importStaticDiseasePages(
      ...(args as Parameters<AdminCatalogApi['importStaticDiseasePages']>),
    );
  }
