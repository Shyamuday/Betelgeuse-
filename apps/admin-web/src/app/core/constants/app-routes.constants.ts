...
export const NAV_ITEMS = [
  ...
  { path: adminNavPath(ROUTE_PATHS.HOME_CAROUSEL), label: '🖼️ Home Carousel' },
  { path: adminNavPath(ROUTE_PATHS.SERVICES), label: '🧾 Services' },
  { path: adminNavPath(ROUTE_PATHS.PUBLIC_PAGES), label: '🧩 Public Pages' },
...
export const NAV_GROUPS: AdminNavGroup[] = [
  ...
  },
  {
    ...
    segments: [
      ...
      ROUTE_PATHS.FAQ,
      ROUTE_PATHS.BLOG,
      ROUTE_PATHS.HOME_CAROUSEL,
      ROUTE_PATHS.SERVICES,
      ROUTE_PATHS.PUBLIC_PAGES,
