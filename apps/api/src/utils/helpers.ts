...
export const patientProfileSelect = {
  ...
  sleepPattern: true,
  dreamNotes: true,
  thermalPreference: true,
  perspirationNotes: true,
  bowelHabits: true,
  urineHabits: true,
  menstrualHistory: true,
  mentalTemperament: true,
  fearsPhobias: true,
  angerGriefPatterns: true,
  concentrationMemory: true,
  socialBehaviour: true,
  stressTriggers: true,
  childhoodIllnesses: true,
  vaccinationHistory: true,
  previousHomeopathicTreatment: true,
  aggravatingFactors: true,
  relievingFactors: true,
  exerciseHabits: true,
  stimulantHabits: true,
