...
export const diabetesMellitusDiseaseInfo: DiseaseInfo = {
  ...
  faq: [
    ...
    },
    {
      ...
      answer:
        'For most adults with Type 2 diabetes, an HbA1c below 7% is the general target. However, targets are individualized — older patients or those with frequent hypoglycemia may have a relaxed target of 7.5–8%. Your doctor will set a target based on your age, duration of diabetes, and comorbidities.'
    },
    {
    ...
    },
    {
      ...
      answer:
        'Frequency depends on your treatment. Patients on insulin may need to check 2–4 times daily. Those on oral medications may check fasting and post-meal readings a few times a week. Your doctor will advise a monitoring schedule based on your control and treatment plan.'
    }
  ],
  careApproach: [
