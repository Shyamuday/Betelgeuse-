...
export class HomeComponent {
  ...
  readonly headerTagline = signal(this.translate.instant('common.digitalClinicTagline'));
  readonly whatsappAriaLabel = signal(this.translate.instant('common.chatWhatsAppAria'));
  ...
  constructor() {
    const refresh = () => {
      this.headerTagline.set(this.translate.instant('common.digitalClinicTagline'));
      this.whatsappAriaLabel.set(this.translate.instant('common.chatWhatsAppAria'));
    };
