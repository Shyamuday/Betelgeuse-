...
export const sehgalMethodApproach: HomeopathyApproach = {
  slug: 'sehgal-method',
  title: 'Sehgal Method',
  ...
  processSteps: ['Identify key emotional disturbance', 'Trace symptom linkage', 'Select remedy on emotional core', 'Monitor emotional and physical shifts'],
