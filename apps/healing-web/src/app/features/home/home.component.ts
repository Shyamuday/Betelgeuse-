      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8 sm:mb-12">
          ...
          <p class="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto">
            Comprehensive tools to support your mental health journey - from assessments and
            exercises to lifestyle tips and educational articles.
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          ...
          >
            ...
            <p class="text-gray-600 mb-4">
              Take clinically validated assessments to understand your mental health status and get
          ...
          >
            ...
            <p class="text-gray-600 mb-4">
              Practice evidence-based exercises for breathing, mindfulness, cognitive therapy, and
              physical wellness.
            </p>
          ...
          >
            ...
            <p class="text-gray-600 mb-4">
              Discover practical lifestyle changes for better sleep, nutrition, social connections,
          ...
          >
            <div
              class="w-12 h-12 bg-indigo-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-indigo-200 transition-colors"
            >
              <svg
            ...
            <p class="text-gray-600 mb-4">
              Read evidence-based articles about depression, anxiety, stress management, and
              self-care from mental health professionals.
            </p>
        ...
        <div class="text-center mt-8 sm:mt-12">
          <div class="bg-white rounded-xl shadow-lg p-6 sm:p-8 max-w-2xl mx-auto">
            ...
            <p class="text-gray-600 mb-6">
              Take a quick assessment to get personalized recommendations for exercises, lifestyle
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8 sm:mb-12">
          ...
          <p class="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
            Comprehensive support for your mental health journey with professional, compassionate
    ...
    <section class="py-12 sm:py-16 bg-gray-50">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8 sm:mb-12">
          ...
          <p class="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
            Connect with others on their healing journey and stay informed about our community
            events.
          </p>
        </div>
          ...
          <div class="bg-white rounded-lg shadow-md p-6 sm:p-8 text-center">
            <div class="mb-4 sm:mb-6">
              ...
              >
                ...
                >
                  <path
                    d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.568 8.16l-1.61 7.59c-.12.54-.44.67-.89.42l-2.46-1.81-1.19 1.14c-.13.13-.24.24-.49.24l.17-2.43 4.47-4.03c.19-.17-.04-.27-.3-.1L9.28 13.47l-2.38-.75c-.52-.16-.53-.52.11-.77l9.28-3.58c.43-.16.81.1.67.73z"
                  />
                </svg>
              </div>
        ...
        <div class="mt-8 sm:mt-12 text-center">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto">
            <div class="p-4 sm:p-6">
              <div
                class="w-10 h-10 sm:w-12 sm:h-12 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4"
              >
                <svg
            ...
            <div class="p-4 sm:p-6">
              ...
              <p class="text-sm sm:text-base text-gray-600">
                Access valuable mental health resources, tips, and educational content.
              </p>
            </div>
            <div class="p-4 sm:p-6">
              <div
              ...
              <p class="text-sm sm:text-base text-gray-600">
                A judgment-free environment where you can share, learn, and grow at your own pace.
              </p>
            </div>
          </div>
        </div>
